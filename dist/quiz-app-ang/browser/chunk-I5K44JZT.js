...
var ReferralService = class _ReferralService {
  router;
  STORAGE_KEY = "ref_full_query";
  // или ref_raw, ref_source_raw и т.д.
  constructor(router) {
    this.router = router;
    this.init();
  }
  init() {
    ...
    this.router.events.pipe(filter((event) => event instanceof NavigationEnd)).subscribe(() => this.saveFullQueryIfPresent());
  }
  /** Сохраняет ВСЮ строку после знака ?, если она есть и не пустая */
  saveFullQueryIfPresent() {
  ...
  static \u0275fac = function ReferralService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ReferralService)(\u0275\u0275inject(Router));
  };
...
var FingerprintService = class _FingerprintService {
  fpPromise = null;
  ...
  static \u0275fac = function FingerprintService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _FingerprintService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _FingerprintService, factory: _FingerprintService.\u0275fac, providedIn: "root" });
};
...
var SessionService = class _SessionService {
  ...
  clearSession() {
    ...
    console.log("\u{1F5D1}\uFE0F \u0421\u0435\u0441\u0441\u0438\u044F \u043E\u0447\u0438\u0449\u0435\u043D\u0430");
  }
...
var UserIdentityService = class _UserIdentityService {
  fingerprintService;
  sessionService;
  referralService;
  identityInitialized = false;
  constructor(fingerprintService, sessionService, referralService) {
  ...
  initialize() {
    return __async(this, null, function* () {
      ...
      console.log("\u{1F680} \u0418\u043D\u0438\u0446\u0438\u0430\u043B\u0438\u0437\u0430\u0446\u0438\u044F \u0438\u0434\u0435\u043D\u0442\u0438\u0444\u0438\u043A\u0430\u0446\u0438\u0438 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F...");
      const visitorId = yield this.fingerprintService.getVisitorId();
  ...
  clearAll() {
    ...
    console.log("\u{1F5D1}\uFE0F \u0412\u0441\u044F \u0438\u0434\u0435\u043D\u0442\u0438\u0444\u0438\u043A\u0430\u0446\u0438\u044F \u043E\u0447\u0438\u0449\u0435\u043D\u0430");
  }
  static \u0275fac = function UserIdentityService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _UserIdentityService)(\u0275\u0275inject(FingerprintService), \u0275\u0275inject(SessionService), \u0275\u0275inject(ReferralService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _UserIdentityService, factory: _UserIdentityService.\u0275fac, providedIn: "root" });
};
...
var UserService = class _UserService {
  ...
  constructor(http, identityService) {
    this.http = http;
  ...
  saveUserSession(sessionData) {
    return __async(this, null, function* () {
      const identity = yield this.identityService.getUserIdentity();
      ...
      console.log("\u{1F4E4} \u041E\u0442\u043F\u0440\u0430\u0432\u043A\u0430 \u0441\u0435\u0441\u0441\u0438\u0438:", fullSessionData);
      this.http.post(`${this.apiUrl}/users/session`, fullSessionData, {
  ...
  addUserResult(result) {
    return __async(this, null, function* () {
      ...
      const resultData = {
        ...
        geo: result.geo || null,
        ref_source: identity.refQuery || null
        // 🎯 Реферальная ссылка
      };
      console.log("\u{1F4E4} \u041E\u0442\u043F\u0440\u0430\u0432\u043A\u0430 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u0430:", resultData);
      this.http.post(`${this.apiUrl}/quiz-results/submit`, resultData, {
        headers: this.getHeaders()
      }).pipe(map((response) => {
  ...
  getBrowserInfo() {
    return __async(this, null, function* () {
      const browserInfo = {
        ...
        ipAddress: yield this.getIpAddress(),
        geolocation: void 0
      };
      if (navigator.geolocation) {
        try {
          browserInfo.geolocation = yield new Promise((resolve) => {
            navigator.geolocation.getCurrentPosition((position) => resolve({
              latitude: position.coords.latitude,
              longitude: position.coords.longitude
            }), () => resolve(void 0), { timeout: 5e3 });
          });
        } catch (error) {
  ...
  static \u0275fac = function UserService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _UserService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(UserIdentityService));
  };
...
//# sourceMappingURL=chunk-I5K44JZT.js.map
